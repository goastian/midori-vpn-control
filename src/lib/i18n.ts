...
const messages: Record<LocaleCode, TranslationTree> = {
  es: {
    ...
    login: {
      ...
      connecting: 'Conectando...',
      providerHint: 'Autenticación vía accounts.astian.org',
    },
    authCallback: {
  ...
  en: {
    ...
    login: { subtitle: 'Control panel', submit: 'Sign in with Astian', connecting: 'Connecting...', providerHint: 'Authentication via accounts.astian.org' },
...
fillLocale('pt', {
  ...
  login: { subtitle: 'Painel de controle', submit: 'Entrar com Astian', connecting: 'Conectando...', providerHint: 'Autenticação via accounts.astian.org' },
