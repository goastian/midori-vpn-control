...
const messages: Record<LocaleCode, TranslationTree> = {
  es: {
    ...
    connectionsView: {
      ...
      scanQr: 'Escanea con tu app móvil',
      downloadQr: 'Descargar QR',
      qrAlt: 'Código QR de configuración WireGuard',
    },
    auditView: {
  ...
  en: {
    ...
    login: { subtitle: 'Control panel', submit: 'Sign in with Astian', connecting: 'Connecting...' },
    ...
    dashboard: { eyebrow: 'Midori Control Center', title: 'Performance dashboard', subtitle: 'Track connections, traffic, and operational health in real time.', cards: { activeConnections: 'Active connections', networkUsage: 'Network usage', currentStatus: 'Current status' }, weeklyTraffic: 'Weekly network traffic', weeklyTrafficSubtitle: 'Accumulated by connection provisioning date.', connectionHealth: 'Connection health', connectionHealthSubtitle: 'Distribution of active and inactive status.', activePlural: 'active', inactivePlural: 'inactive', performanceByDevice: 'Performance by device', noDeviceTraffic: 'No per-device traffic data yet.', recentActivity: 'Recent activity', noRecentConnections: 'No recent connections to display.', platformMetrics: 'Platform metrics', platformMetricsSubtitle: 'General summary of the managed infrastructure.', globalTraffic: 'Global traffic', activeLabel: 'Active', inactiveLabel: 'Inactive', connectionsActiveSuffix: '{count} active connection(s)' },
    serversView: { title: 'VPN servers', empty: 'No servers available.', load: 'Load' },
    connectionsView: { title: 'My VPN connections', newConnection: 'New connection', autoServer: 'Auto (least loaded)', deviceNamePlaceholder: 'Device name (optional)', publicKeyPlaceholder: 'Your WireGuard public key', configTitle: 'WireGuard configuration', copied: 'Configuration copied to clipboard. It will be cleared in 60 seconds.', closeConfig: 'Close', empty: 'You have no active connections.', disconnectConfirm: 'Disconnect this device?', trafficHeader: 'Traffic', scanQr: 'Scan with your mobile app', downloadQr: 'Download QR', qrAlt: 'WireGuard configuration QR code' },
...
fillLocale('ru', {
  ...
  connectionsView: { title: 'Мои VPN-подключения', newConnection: 'Новое подключение', autoServer: 'Авто (минимальная нагрузка)', deviceNamePlaceholder: 'Имя устройства (необязательно)', publicKeyPlaceholder: 'Ваш публичный ключ WireGuard', configTitle: 'Конфигурация WireGuard', copied: 'Конфигурация скопирована в буфер обмена. Она будет очищена через 60 секунд.', closeConfig: 'Закрыть', empty: 'У вас нет активных подключений.', disconnectConfirm: 'Отключить это устройство?', scanQr: 'Сканируйте мобильным приложением', downloadQr: 'Скачать QR', qrAlt: 'QR-код конфигурации WireGuard' },
})
...
fillLocale('uk', {
  ...
  connectionsView: { title: 'Мої VPN-підключення', newConnection: 'Нове підключення', autoServer: 'Авто (найменше навантаження)', deviceNamePlaceholder: 'Назва пристрою (необов’язково)', publicKeyPlaceholder: 'Ваш публічний ключ WireGuard', configTitle: 'Конфігурація WireGuard', copied: 'Конфігурацію скопійовано в буфер обміну. Її буде очищено через 60 секунд.', closeConfig: 'Закрити', empty: 'У вас немає активних підключень.', disconnectConfirm: 'Відключити цей пристрій?', scanQr: 'Скануйте мобільним додатком', downloadQr: 'Завантажити QR', qrAlt: 'QR-код конфігурації WireGuard' },
})
