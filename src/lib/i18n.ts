...
const messages: Record<LocaleCode, TranslationTree> = {
  es: {
    ...
    landing: {
      ...
      downloadTitle: 'Descarga el cliente de escritorio',
      downloadSubtitle: 'Conéctate a MidoriVPN desde tu computadora. Elige tu sistema operativo.',
      osLinux: 'Linux',
      osWindows: 'Windows',
      osMacOS: 'macOS',
    ...
    dashboard: {
      ...
      desktopDownload: {
        ...
        actions: {
          ...
          linuxDeb: 'Linux paquete (.deb)',
          linuxRpm: 'Linux paquete (.rpm)',
        ...
        hints: {
          ...
          linuxDeb: 'Paquete recomendado para Debian, Ubuntu y derivadas.',
          linuxRpm: 'Paquete recomendado para Fedora, RHEL, SUSE y derivadas.',
          linuxAppImage: 'Versión portable que no requiere instalación.',
        },
      },
    },
    serversView: {
    ...
    dashboard: {
      ...
      desktopDownload: {
        ...
        hints: {
          ...
          linuxDeb: 'Recommended package for Debian, Ubuntu, and derivatives.',
          linuxRpm: 'Recommended package for Fedora, RHEL, SUSE, and derivatives.',
          linuxAppImage: 'Portable version that does not require installation.',
        },
      },
    },
