    ...
    dashboard: {
      ...
      desktopDownload: {
        ...
        actions: {
          ...
          linuxPackage: 'Linux package (.deb)',
        ...
        hints: {
          ...
          linuxPackage: 'Paquete recomendado para Debian, Ubuntu y derivadas.',
    ...
    dashboard: {
      ...
      desktopDownload: {
        ...
        hints: {
          ...
          linuxPackage: 'Recommended package for Debian, Ubuntu, and derivatives.',
