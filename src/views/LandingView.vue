    ...
    <section class="py-20 sm:py-28">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="https://github.com/goastian/midori-vpn-core" target="_blank" rel="noopener" class="inline-flex items-center px-6 py-3.5 text-base font-semibold text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2.5">
              <li><a href="https://astian.org" target="_blank" rel="noopener" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">About Astian</a></li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-4">
            <a href="https://github.com/goastian" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-600 transition-colors">
